...
class PostgresqlOperatorCharm(TypedCharmBase[CharmConfig]):
    ...
    def _validate_config_options(self) -> None:
        ...
        if self.config.storage_default_table_access_method not in self.postgresql.get_postgresql_default_table_access_methods():
            raise ValueError("storage_default_table_access_method config option has an invalid value")

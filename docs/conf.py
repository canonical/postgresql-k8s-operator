...
project = "Charmed PostgreSQL K8s"
...
ogp_site_url = "https://charmed-postgresql-k8s.readthedocs-hosted.com/"
...
html_context = {
    ...
    "github_url": "https://github.com/canonical/postgresql-k8s-operator",
    
    # Docs branch in the repo; used in links for viewing the source files
    # TODO: Update when default branch changes to 14 or 16
...
#
html_theme_options = {
'source_edit_link': 'https://github.com/canonical/postgresql-k8s-operator',
}

...
Find all details about default and extra DB user roles in "[Charm Users explanations](/t/10843)".

## Legacy interfaces

**Note:** Legacy relations are deprecated and will be discontinued on future releases. Usage should be avoided. Check the legacy interface implementation limitations in the "[Legacy charm](/t/11013)" document.
